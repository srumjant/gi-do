...
const PROMPT_FONT = { fontFamily: GAME_FONT_BOLD, fontSize: '12px', color: '#ffdd00', resolution: GAME_TEXT_RESOLUTION };
const TARGET_FONT = { fontFamily: GAME_FONT_BOLD, fontSize: '26px', color: '#ffffff', resolution: GAME_TEXT_RESOLUTION };
const SPEAK_FONT = { fontFamily: GAME_FONT_BOLD, fontSize: '12px', color: '#aaddff', resolution: GAME_TEXT_RESOLUTION };
